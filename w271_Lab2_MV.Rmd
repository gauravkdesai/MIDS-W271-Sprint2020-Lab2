...
The seasonality in the data shows that every October, co2 levels are lowest, and in May, co2 levels are highest. The seasonal trend every year precisely follows the same pattern. 
**Part 2 (3 points)**
...
quad.predict = quad.trend.fit2$coefficients[1] + quad.trend.fit2$coefficients[2]*predict.data$x 
