...
co2.noaa.weekly.ts.2020 <- co2.noaa.weekly.ts %>%
  filter_index("2019-12-31" ~.) 

co2.noaa.monthly.ts.2020 <- co2.noaa.weekly.ts %>%
  filter_index("2019-12-31" ~.) %>%
  as_tibble() %>%
...
autoplot(co2.2020.pred.ts, .vars = value, color="red") +
  autolayer(co2.noaa.monthly.ts.2020, .vars = avg_value, color="blue") 
